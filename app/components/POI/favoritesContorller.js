...
mainApp.controller('favCtrl', ['commentSrvc', '$http', 'setID', 'localStorageService', '$location','$rootScope','$route',
    function (commentSrvc, $http, setID, localStorageService, $location, $rootScope,$route) {
